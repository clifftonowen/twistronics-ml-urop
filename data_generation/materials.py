...
EPS = {
    ...
    "SiO2": 2.10,      # n ~ 1.45, low-index spacer  (CLAUDE.md: eps_r ~ 2)
    "Si3N4": 4.00,     # n ~ 2.00, high-index slab   (CLAUDE.md: eps_r ~ 4)
